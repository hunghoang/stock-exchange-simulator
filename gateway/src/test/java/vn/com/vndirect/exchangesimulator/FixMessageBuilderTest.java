...
public class FixMessageBuilderTest {
	...
	public void testParseMessage() {
		List<String> messages = tcpReceiver.receive("8=FIX.4.49=8335=A49=021.01GW56=HNX34=052=xx:yy:zz369=098=0108=30553=021.01GW554=27216810=138".getBytes());
	...
	@Test	public void testReadByteStream(){
		...
		List<String> messages = tcpReceiver.receive(bytes);
	...
	public void testReadByteStream_HalfAndAHalf(){
		...
		messages = tcpReceiver.receive(bytes);
